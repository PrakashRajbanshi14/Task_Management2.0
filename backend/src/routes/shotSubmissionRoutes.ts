...
import ShotSubmissionControllers from "../controller/shotSubmisionControllers";
...
router.get(
  ...
  accessToRoles(UserRole.Employee, UserRole.ProjectManager, UserRole.Admin),

  ShotSubmissionControllers.getAllSubmissionsOfShot,
);
...
router.get(
  ...
  ShotSubmissionControllers.getSubmissionById,
);
